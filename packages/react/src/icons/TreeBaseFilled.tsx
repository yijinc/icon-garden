...
export default ({ size = 48, color = "black" }: IIconProps) => (
    ...
    >
        ...
        <path
            ...
            fill={color}
        />
        <path d="M22.1289 9H27.1289V38H22.1289V9Z" fill={color} />
        <path d="M22.1289 6H32.1289V11H22.1289V6Z" fill={color} />
        <path d="M22.1289 36H32.1289V41H22.1289V36Z" fill={color} />
        <path d="M16.1289 21H24.1289V26H16.1289V21Z" fill={color} />
    </svg>
);
